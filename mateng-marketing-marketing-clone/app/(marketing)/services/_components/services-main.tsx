...
export function ServicesMain() {
  return (
    ...
    <iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQdF2f66XVKdulayJ7yBHc6BMLYvn1sXuJIq83gZvDN5ugZrp5uQfcVzqVXe94Iu1WNM0ooE072u0lw/pubhtml" width="100%" height="600" frameborder="0" scrolling="no"></iframe>
  );
}
